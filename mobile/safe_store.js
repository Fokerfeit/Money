...
// Mode 0o600 (owner read/write only): these stores can hold private keys/secrets
// (identity_store.js, the self-gate nullifier store) — fs.openSync's default mode
// is 0o666 as-modified-by-umask, which on a typical 0o022 umask leaves the file
// world-readable. Explicit mode here means the file is owner-only regardless of
// the process/system umask (fixed after Cowork flagged it CRITICAL on 4b73844).
